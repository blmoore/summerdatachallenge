...
%\vspace{-1em}
\centering
\includegraphics[width=.44\textwidth]{Figures/grading.png}
\vspace{-1em}
...
In this report I've given a brief overview my attempts to elute maximal
insight from a single large dataset through the data science techniques of
visualisation and quantitative modelling. Together they form a
cohesive narrative of investigative analysis into a single exemplar
postcode, and discovery of the potential investment returns
therein. 

These analyses have to potential to generate valuable insights for a range of
customer segments:
\begin{itemize}
...
\item A consultancy specialising in real estate investment to partner
  with REITs and other specialist investment funds, as well as charitable trusts.
\end{itemize}
